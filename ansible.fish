# extracted from https://github.com/ansible/ansible/blob/devel/hacking/env-setup.fish
...
function init --on-event init_ansible
  if not set -q ANSIBLE_HOME
    ...
    echo "Ansible can be fetched using 'git clone --depth 1 --recursive https://github.com/ansible/ansible.git'."
  else
